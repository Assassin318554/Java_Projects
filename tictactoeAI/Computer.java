    ...
    void play(TicTacToe ticTacToe, int index){
        ...
        // After player move 2 time
            ...
            // Case 2
                ...
                if(storeValue.get(1) == 2 || storeValue.get(1) == 3 || storeValue.get(1) == 7){
                    ticTacToe.buttons[0].setFont(new Font("Sans",Font.PLAIN,50));
                    ticTacToe.buttons[0].setLabel("O");
                }
                else if(storeValue.get(1) == 0 || storeValue.get(1) == 5){
            ...
            // Case 3
                ...
                if(storeValue.get(1) == 0 || storeValue.get(1) == 5 || storeValue.get(1) == 7){
                    ticTacToe.buttons[6].setFont(new Font("Sans",Font.PLAIN,50));
                    ticTacToe.buttons[6].setLabel("O");
                }
                if(storeValue.get(1) == 1 || storeValue.get(1) == 6){
                    ticTacToe.buttons[0].setFont(new Font("Sans",Font.PLAIN,50));
                    ticTacToe.buttons[0].setLabel("O");
                }
                if(storeValue.get(1) == 2){
            ...
            // Case 4
                ...
                if(storeValue.get(1) == 1 || storeValue.get(1) == 3 || storeValue.get(1) == 8){
                    ticTacToe.buttons[2].setFont(new Font("Sans",Font.PLAIN,50));
                    ticTacToe.buttons[2].setLabel("O");
                }
                else if(storeValue.get(1) == 2 || storeValue.get(1) == 7){
                    ticTacToe.buttons[8].setFont(new Font("Sans",Font.PLAIN,50));
                    ticTacToe.buttons[8].setLabel("O");
                }
                else if(storeValue.get(1) == 0){
                    ticTacToe.buttons[7].setFont(new Font("Sans",Font.PLAIN,50));
                    ticTacToe.buttons[7].setLabel("O");
                }
                else if(storeValue.get(1) == 6){
            ...
            // Case 5
                ...
                if(storeValue.get(1) == 1 || storeValue.get(1) == 5 || storeValue.get(1) == 6){
                    ticTacToe.buttons[8].setFont(new Font("Sans",Font.PLAIN,50));
                    ticTacToe.buttons[8].setLabel("O");
                }
                else if(storeValue.get(1) == 3 || storeValue.get(1) == 8){
                    ticTacToe.buttons[6].setFont(new Font("Sans",Font.PLAIN,50));
                    ticTacToe.buttons[6].setLabel("O");
                }
                else if(storeValue.get(1) == 0){
            ...
            // Case 7
                ...
                else if(storeValue.get(1) == 1 || storeValue.get(1) == 6){
                    ticTacToe.buttons[2].setFont(new Font("Sans",Font.PLAIN,50));
                    ticTacToe.buttons[2].setLabel("O");
                }
                else if(storeValue.get(1) == 3){
            ...
            // Case 8
                ...
                else if(storeValue.get(1) == 8 || storeValue.get(1) == 2){
                    ticTacToe.buttons[7].setFont(new Font("Sans",Font.PLAIN,50));
                    ticTacToe.buttons[7].setLabel("O");
                }
                else if(storeValue.get(1) == 1){
                    ticTacToe.buttons[5].setFont(new Font("Sans",Font.PLAIN,50));
                    ticTacToe.buttons[5].setLabel("O");
                }
                else if(storeValue.get(1) == 5){
            ...
            // Case 8
                ...
                else if(storeValue.get(1) == 2 || storeValue.get(1) == 0){
                    ticTacToe.buttons[5].setFont(new Font("Sans",Font.PLAIN,50));
                    ticTacToe.buttons[5].setLabel("O");
                }
                else if(storeValue.get(1) == 3){
        ...
        // After player move 3 time
            ...
            // Case 6
                ...
                if(storeValue.get(1) == 1){
                    if(storeValue.get(2) != 6){
                        ticTacToe.buttons[6].setFont(new Font("Sans", Font.PLAIN, 50));
                        ticTacToe.buttons[6].setLabel("O");
                    }
                    else if(storeValue.get(2) == 6){
                        ticTacToe.buttons[3].setFont(new Font("Sans",Font.PLAIN,50));
                        ticTacToe.buttons[3].setLabel("O");
                    }
                }
                else if(storeValue.get(1) == 2){
                    if(storeValue.get(2) != 7){
                        ticTacToe.buttons[7].setFont(new Font("Sans", Font.PLAIN, 50));
                        ticTacToe.buttons[7].setLabel("O");
                    }
                    else if(storeValue.get(2) == 7){
                        ticTacToe.buttons[6].setFont(new Font("Sans",Font.PLAIN,50));
                        ticTacToe.buttons[6].setLabel("O");
                    }
                }
                else if(storeValue.get(1) == 3){
                    if(storeValue.get(2) != 2){
                        ticTacToe.buttons[2].setFont(new Font("Sans", Font.PLAIN, 50));
                        ticTacToe.buttons[2].setLabel("O");
                    }
                    else if(storeValue.get(2) == 2){
                        ticTacToe.buttons[1].setFont(new Font("Sans",Font.PLAIN,50));
                        ticTacToe.buttons[1].setLabel("O");
                    }
                }
                else if(storeValue.get(1) == 5){
                    if(storeValue.get(2) != 1){
                        ticTacToe.buttons[1].setFont(new Font("Sans", Font.PLAIN, 50));
                        ticTacToe.buttons[1].setLabel("O");
                    }
                    else if(storeValue.get(2) == 1){
                        ticTacToe.buttons[2].setFont(new Font("Sans",Font.PLAIN,50));
                        ticTacToe.buttons[2].setLabel("O");
                    }
                }
                else if(storeValue.get(1) == 6){
                    if(storeValue.get(2) != 5){
                        ticTacToe.buttons[5].setFont(new Font("Sans", Font.PLAIN, 50));
                        ticTacToe.buttons[5].setLabel("O");
                    }
                    else if(storeValue.get(2) == 5){
                        ticTacToe.buttons[2].setFont(new Font("Sans",Font.PLAIN,50));
                        ticTacToe.buttons[2].setLabel("O");
                    }
                }
            ...
            // Case 7
                ...
                if(storeValue.get(1) == 5){
                    ...
                    if(storeValue.get(2) != 3){
                        ticTacToe.buttons[3].setFont(new Font("Sans", Font.PLAIN, 50));
                        ticTacToe.buttons[3].setLabel("O");
                    }
                    else if(storeValue.get(2) == 3){
                        ticTacToe.buttons[0].setFont(new Font("Sans",Font.PLAIN,50));
                        ticTacToe.buttons[0].setLabel("O");
                    }
                }
                else if(storeValue.get(1) == 1){
                    if(storeValue.get(2) != 8){
                        ticTacToe.buttons[8].setFont(new Font("Sans", Font.PLAIN, 50));
                        ticTacToe.buttons[8].setLabel("O");
                    }
                    else if(storeValue.get(2) == 8){
                        ticTacToe.buttons[5].setFont(new Font("Sans",Font.PLAIN,50));
                        ticTacToe.buttons[5].setLabel("O");
                    }
                }
